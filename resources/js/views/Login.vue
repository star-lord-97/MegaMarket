            ...
            <form class="mt-8 space-y-6">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <a
                        ...
                        href="http://megamarket0.herokuapp.com/api/auth/facebook/redirect"
                    >
                        <span
                            class="absolute left-0 inset-y-0 flex items-center pl-3"
                        >
                    ...
                    <a
                        ...
                        href="http://megamarket0.herokuapp.com/api/auth/github/redirect"
                    >
                        <span
                            class="absolute left-0 inset-y-0 flex items-center pl-3"
                        >
                    ...
                    <a
                        class="group relative w-full flex justify-center my-1 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-black hover:no-underline hover:text-black"
                        href="http://megamarket0.herokuapp.com/api/auth/google/redirect"
                    >
                        <span
                            class="absolute left-0 inset-y-0 flex items-center pl-3"
                        >
